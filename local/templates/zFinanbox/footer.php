    ...
    <footer>
			<div class="top-footer">
				<div id="owl-brand" class="owl-carousel">
					<div class="item">
						<a href="single.html"><img src="<?=SITE_TEMPLATE_PATH?>/images/15.jpg" /></a>
					</div>
					<div class="item">
						<a href="single.html"><img src="<?=SITE_TEMPLATE_PATH?>/images/16.jpg" /></a>
					</div>
					<div class="item">
						<a href="single.html"><img src="<?=SITE_TEMPLATE_PATH?>/images/17.jpg" /></a>
					</div>
					<div class="item">
						<a href="single.html"><img src="<?=SITE_TEMPLATE_PATH?>/images/18.jpg" /></a>
					</div>
					<div class="item">
						<a href="single.html"><img src="<?=SITE_TEMPLATE_PATH?>/images/19.jpg" /></a>
					</div>
					<div class="item">
						<a href="single.html"><img src="<?=SITE_TEMPLATE_PATH?>/images/20.jpg" /></a>
					</div>
					<div class="item">
						<a href="single.html"><img src="<?=SITE_TEMPLATE_PATH?>/images/21.jpg" /></a>
					</div>
				</div>
			</div>
